...
import (
	...
	"github.com/meta-apex/gopkg/threading"
...
func gracefulStop(signals chan os.Signal, sig syscall.Signal) {
	...
	zlog.Info().Msgf("Got signal %d, shutting down...", sig)
	...
	zlog.Info().Msgf("Still alive after %v, going to force kill the process...", waitTime)
